module TransactionsHelper
  ...
  def getEditTitle(transaction_type)
    return {0.to_s(10) => I18n.t(:form_edit_transaction_to_account_title),
            1.to_s(10) => I18n.t(:form_edit_transaction_from_account_to_account_title),
            2.to_s(10) => I18n.t(:form_edit_transaction_from_account_to_cash_title),
            3.to_s(10) => I18n.t(:form_edit_transaction_from_account_to_category_title),
            4.to_s(10) => I18n.t(:form_edit_transaction_to_cash_title),
            5.to_s(10) => I18n.t(:form_edit_transaction_from_cash_to_account_title),
            6.to_s(10) => I18n.t(:form_edit_transaction_from_cash_to_cash_title),
            7.to_s(10) => I18n.t(:form_edit_transaction_from_cash_to_category_title)}[transaction_type]
  end
end
